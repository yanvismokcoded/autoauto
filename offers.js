...
const ALREADY_RE = /(?<![а-яa-z])уже(?![а-яa-z])\s*(?:\S+\s+){0,2}(?:тап\S*|вз\S*|взаимн\S*|взаимк\S*|делали|сделали|было)|(?<![а-яa-z])(?:тапал\S*|тапнул\S*|взшал\S*|взшлись|взялись)(?![а-яa-z])/;
